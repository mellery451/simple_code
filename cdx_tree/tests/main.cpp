...
START_TEST(simple_ordered)
{
    std::stringstream ssin, ssout, ssexpect;

    ssin << "15 2 25 first description" << std::endl
         << "2 1 3 another" << std::endl
         << "1 one" << std::endl 
         << "3 three" << std::endl
         << "25 twenty-five" << std::endl;
...
{
    int number_failed;
    Suite *s = suite_create("tree_thing");
    ...
    TCase *tc3 = tcase_create("bad input");
    tcase_add_test(tc3, bad_input_no_description);
